...
> HARMFUL: Mutations can cause genetic disorders, for example cystic fibrosis.

> BENIFICIAL: Produce in charecteristics that can be beneficial to the organism - mutation in plasmid genes of bacterial cell can mkae them resistant to antibiotics.

> NEUTRAL: Some mutations are neither harmful nor beneficial - they don't affect a protein's function.
